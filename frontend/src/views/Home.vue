  ...
  <div class="min-h-screen text-black flex flex-col pb-28 sm:pb-20 selection:bg-[#9333EA]/20 relative z-10">
    ...
    <main class="flex-grow max-w-2xl mx-auto w-full px-4 pt-12 pb-8 flex flex-col items-center relative z-10">
      ...
      <div class="text-center mb-10 w-full animate-fade-in-down">
        <span class="text-[#7E22CE] font-bold tracking-[0.25em] text-xs uppercase block mb-3">
          The Word of the Day
        </span>
        <h2 class="font-serif text-2xl md:text-3xl text-black mb-3 leading-snug">
          "Abide in My love."
        </h2>
        <p class="text-black/80 text-sm leading-relaxed max-w-md mx-auto">
      ...
      <div class="w-full space-y-4 animate-fade-in-up delay-150">
        ...
        <router-link to="/daily-readings" class="block">
          <ParchmentCard hover-effect class="!p-5 flex items-center justify-between">
            <div class="flex items-center space-x-4">
              <div class="w-12 h-12 rounded-xl bg-[#E9D5FF]/30 flex items-center justify-center text-[#9333EA] shadow-sm">
              ...
              <div class="text-left">
                <h3 class="font-serif text-base md:text-lg font-bold text-[#7E22CE]">Daily Mass Readings</h3>
                <p class="text-xs md:text-sm text-black mt-0.5 leading-snug max-w-md">
                  Follow the universal Church in its daily scriptural cycle. Today: Memorial of St. Polycarp.
                </p>
              </div>
            </div>
            <div class="text-[#9333EA]/50 group-hover:text-[#9333EA] transition-colors pl-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#9333EA" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
        ...
        <router-link to="/rosary" class="block">
          <ParchmentCard hover-effect class="!p-5 flex items-center justify-between">
            <div class="flex items-center space-x-4">
              ...
              <div class="text-left">
                <h3 class="font-serif text-base md:text-lg font-bold text-[#7E22CE]">Scriptural Rosary</h3>
                <p class="text-xs md:text-sm text-black mt-0.5 leading-snug max-w-md">
        ...
        <router-link to="/st-michael-rosary" class="block">
          <ParchmentCard hover-effect class="!p-5 flex items-center justify-between">
            <div class="flex items-center space-x-4">
              <div class="w-12 h-12 rounded-xl bg-[#E9D5FF]/30 flex items-center justify-center text-[#9333EA] shadow-sm">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#9333EA" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              ...
              <div class="text-left">
                <h3 class="font-serif text-base md:text-lg font-bold text-[#7E22CE]">St. Michael Chaplet</h3>
                <p class="text-xs md:text-sm text-black mt-0.5 leading-snug max-w-md">
        ...
        <router-link to="/divine-mercy" class="block">
          <ParchmentCard hover-effect class="!p-5 flex items-center justify-between">
            <div class="flex items-center space-x-4">
              ...
              <div class="text-left">
                <h3 class="font-serif text-base md:text-lg font-bold text-[#7E22CE]">Divine Mercy</h3>
                <p class="text-xs md:text-sm text-black mt-0.5 leading-snug max-w-md">
        ...
        <router-link to="/catechism" class="block">
          <ParchmentCard hover-effect class="!p-5 flex items-center justify-between">
            <div class="flex items-center space-x-4">
              ...
              <div class="text-left">
                <h3 class="font-serif text-base md:text-lg font-bold text-[#7E22CE]">Catechism</h3>
                <p class="text-xs md:text-sm text-black mt-0.5 leading-snug max-w-md">
        ...
        <router-link to="/prayers" class="block">
          <ParchmentCard hover-effect class="!p-5 flex items-center justify-between">
            <div class="flex items-center space-x-4">
              ...
              <div class="text-left">
                <h3 class="font-serif text-base md:text-lg font-bold text-[#7E22CE]">Traditional Prayers</h3>
                <p class="text-xs md:text-sm text-black mt-0.5 leading-snug max-w-md">
        ...
        <router-link to="/resources" class="block">
          <ParchmentCard hover-effect class="!p-5 flex items-center justify-between">
            <div class="flex items-center space-x-4">
              ...
              <div class="text-left">
                <h3 class="font-serif text-base md:text-lg font-bold text-[#7E22CE]">Early Church Resources</h3>
                <p class="text-xs md:text-sm text-black mt-0.5 leading-snug max-w-md">
        ...
        <router-link to="/bible-study" class="block">
          <ParchmentCard hover-effect class="!p-5 flex items-center justify-between">
            <div class="flex items-center space-x-4">
              ...
              <div class="text-left">
                <h3 class="font-serif text-base md:text-lg font-bold text-[#7E22CE]">Bible Study</h3>
                <p class="text-xs md:text-sm text-black mt-0.5 leading-snug max-w-md">
        ...
        <!-- Magisterium AI Chat -->
        <router-link to="/magisterium-chat" class="block">
          <ParchmentCard hover-effect class="!p-5 flex items-center justify-between">
            <div class="flex items-center space-x-4">
              <div class="w-12 h-12 rounded-xl bg-[#E9D5FF]/30 flex items-center justify-center text-[#9333EA] shadow-sm">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#9333EA" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              ...
              <div class="text-left">
                <h3 class="font-serif text-base md:text-lg font-bold text-[#7E22CE]">Magisterium AI Chat</h3>
                <p class="text-xs md:text-sm text-black mt-0.5 leading-snug max-w-md">
